...
const GUIDE_CATEGORIES = [
  { key: 'academic', name: '教务', icon: '📖', color: '#4A90D9' },
  { key: 'logistics', name: '后勤', icon: '🔧', color: '#2ECC71' },
  { key: 'finance', name: '财务', icon: '💰', color: '#F39C12' },
  { key: 'career', name: '就业', icon: '💼', color: '#9B59B6' },
  { key: 'abroad', name: '出国', icon: '✈️', color: '#E74C3C' },
  { key: 'life', name: '生活服务', icon: '🏠', color: '#1ABC9C' }
];

const GUIDE_LIST_DATA = [
  {
    id: 'guide_academic_001',
    title: '学生证办理与补办',
    category: 'academic',
    icon: '🎫',
    summary: '学生证新办、补办完整流程',
    estimatedTime: '3-5个工作日',
    location: '行政楼205室 学生处综合服务窗口',
    phone: '010-12345003',
    materials: ['身份证原件', '1寸免冠照片1张', '《学生证补办申请表》', '工本费20元'],
    steps: [
      { step: 1, title: '下载申请表', desc: '到学生处官网下载《学生证补办申请表》' },
      { step: 2, title: '辅导员签字', desc: '填写完整后由辅导员签字盖章' },
      { step: 3, title: '窗口办理', desc: '携带申请表、身份证和照片到行政楼205室办理' },
      { step: 4, title: '缴纳费用', desc: '缴纳工本费20元' },
      { step: 5, title: '领取新证', desc: '3个工作日后凭取件凭证领取新证' }
    ],
    content: '## 办理条件\n\n全日制在读学生均可申请办理学生证。新生入学后由学校统一办理，学生证遗失或损坏可申请补办。\n\n## 注意事项\n\n1. 学生证仅限本人使用，不得转借他人\n2. 学生证需每学期开学时到学院注册盖章\n3. 火车票优惠卡每年需充磁一次\n4. 毕业时需将学生证交回学校\n\n## 办理时间\n\n周一至周五 8:30-11:30，14:00-17:00（节假日及寒暑假除外）'
  },
  {
    id: 'guide_academic_002',
    title: '成绩单办理',
    category: 'academic',
    icon: '📄',
    summary: '中英文成绩单申请流程',
    estimatedTime: '1-3个工作日',
    location: '教务处服务大厅（行政楼1楼）',
    phone: '010-12345002',
    materials: ['身份证原件', '校园卡', '成绩单申请表', '工本费（中文10元/份，英文20元/份）'],
    steps: [
      { step: 1, title: '填写申请', desc: '在教务处服务大厅领取并填写成绩单申请表' },
      { step: 2, title: '选择类型', desc: '选择中文或英文成绩单，注明份数' },
      { step: 3, title: '缴费', desc: '到收费窗口缴纳工本费' },
      { step: 4, title: '领取', desc: '1-3个工作日后凭缴费凭证领取' }
    ],
    content: '## 成绩单类型\n\n- **中文成绩单**：10元/份\n- **英文成绩单**：20元/份\n- **密封成绩单**：另加5元/份\n\n## 线上申请\n\n登录教务系统 → 成绩管理 → 成绩单申请 → 在线缴费 → 快递送达\n\n## 注意事项\n\n1. 成绩单加盖教务处公章方为有效\n2. 申请出国留学建议多备几份英文成绩单\n3. 成绩单一经出具不予退费'
  },
  {
    id: 'guide_academic_003',
    title: '选课与退课',
    category: 'academic',
    icon: '📚',
    summary: '选课退课操作流程及注意事项',
    estimatedTime: '即时（选课期间）',
    location: '线上操作（教务系统）',
    phone: '010-12345002',
    materials: ['无特殊材料', '需提前了解培养方案课程要求'],
    steps: [
      { step: 1, title: '查看培养方案', desc: '登录教务系统查看本专业培养方案及课程要求' },
      { step: 2, title: '制定选课计划', desc: '根据学分要求和时间安排制定个人选课计划' },
      { step: 3, title: '第一轮选课', desc: '在规定时间内登录教务系统进行选课' },
      { step: 4, title: '确认结果', desc: '查看选课结果，确认是否中选' },
      { step: 5, title: '补退选', desc: '在补退选阶段调整课程' }
    ],
    content: '## 选课时间\n\n- **第一轮选课**：每学期第12-13周\n- **补退选**：每学期第14-15周\n- **开学退补选**：开学第1-2周\n\n## 选课规则\n\n1. 需满足先修课程要求\n2. 注意课程时间冲突\n3. 注意学分上限（一般不超过28学分）\n4. 体育课需按俱乐部制选课\n\n## 退课规定\n\n- 退课需在规定时间内完成\n- 退课后学分不足可能影响毕业\n- 已开课2周后原则上不允许退课'
  },
  {
    id: 'guide_academic_004',
    title: '学籍异动办理',
    category: 'academic',
    icon: '🔄',
    summary: '休学、复学、转专业等学籍异动流程',
    estimatedTime: '5-10个工作日',
    location: '教务处学籍管理科（行政楼2楼）',
    phone: '010-12345002',
    materials: ['学籍异动申请表', '家长知情同意书', '相关证明材料', '辅导员意见'],
    steps: [
      { step: 1, title: '咨询辅导员', desc: '先与辅导员沟通，了解异动政策和影响' },
      { step: 2, title: '填写申请表', desc: '到教务处领取并填写学籍异动申请表' },
      { step: 3, title: '辅导员审核', desc: '辅导员签字并给出意见' },
      { step: 4, title: '学院审批', desc: '提交至学院教务办公室审批' },
      { step: 5, title: '教务处审批', desc: '教务处学籍管理科最终审批' },
      { step: 6, title: '办理手续', desc: '审批通过后办理相关手续' }
    ],
    content: '## 异动类型\n\n- **休学**：因病或特殊原因可申请休学，期限一般为1年\n- **复学**：休学期满前2周申请复学\n- **转专业**：大一第二学期可申请，需通过考核\n- **降级**：累计不及格学分达到规定标准\n\n## 注意事项\n\n1. 学籍异动影响较大，请慎重考虑\n2. 休学期间不享受在校生待遇\n3. 转专业需同时满足转入转出条件\n4. 学籍异动可能影响奖助学金评定'
  },
  {
    id: 'guide_logistics_001',
    title: '宿舍报修流程',
    category: 'logistics',
    icon: '🔨',
    summary: '水电设施、家具设备报修指引',
    estimatedTime: '30分钟-24小时（视紧急程度）',
    location: '各宿舍楼值班室 / 后勤楼201室',
    phone: '010-12345403',
    materials: ['报修人信息', '宿舍号', '故障描述', '故障照片（建议提供）'],
    steps: [
      { step: 1, title: '选择报修方式', desc: '线上（公众号）或线下（值班室）报修' },
      { step: 2, title: '填写报修信息', desc: '填写宿舍号、联系电话、故障描述' },
      { step: 3, title: '上传照片', desc: '建议上传故障照片便于维修人员准备' },
      { step: 4, title: '等待响应', desc: '紧急30分钟内，一般24小时内响应' },
      { step: 5, title: '配合维修', desc: '维修人员上门前会电话联系' },
      { step: 6, title: '确认签字', desc: '维修完成后在报修单上签字确认' }
    ],
    content: '## 报修范围\n\n✅ **可报修项目**：水龙头、灯具、插座、空调、热水器、床架、桌椅、门窗、网络\n\n❌ **不予维修**：人为损坏、私拉电线、违章电器\n\n## 紧急报修\n\n水管爆裂、严重漏水等紧急情况请拨打24小时热线：010-12345403\n\n## 监督投诉\n\n对维修不满意可拨打物业监督电话：010-12345405'
  },
  {
    id: 'guide_logistics_002',
    title: '校园卡挂失与补办',
    category: 'logistics',
    icon: '💳',
    summary: '校园卡挂失、解挂、补办全流程',
    estimatedTime: '立等可取（补办）',
    location: '生活服务中心1楼 校园卡服务中心',
    phone: '010-12345801',
    materials: ['身份证原件', '补办工本费30元'],
    steps: [
      { step: 1, title: '挂失', desc: '通过公众号/电话/自助机进行挂失' },
      { step: 2, title: '携带证件', desc: '携带身份证到校园卡服务中心' },
      { step: 3, title: '填写申请', desc: '填写补办申请表' },
      { step: 4, title: '缴费制卡', desc: '缴纳30元工本费，现场拍照制卡' },
      { step: 5, title: '领取新卡', desc: '立等可取，旧卡余额自动转入新卡' }
    ],
    content: '## 挂失方式\n\n- **电话挂失**：拨打24小时热线 010-12345801\n- **线上挂失**：校园卡公众号选择"挂失"\n- **自助机挂失**：任意自助圈存机\n\n⚠️ 挂失后24小时内的损失由本人承担\n\n## 服务时间\n\n- 人工窗口：周一至周日 8:00-20:00\n- 自助服务：24小时\n\n## 注意事项\n\n1. 校园卡仅限本人使用\n2. 避免弯曲、接触磁场\n3. 离校时需办理销户退款'
  },
  {
    id: 'guide_logistics_003',
    title: '宿舍入住与退宿',
    category: 'logistics',
    icon: '🏠',
    summary: '宿舍分配、入住登记、退宿办理流程',
    estimatedTime: '1-2个工作日',
    location: '学生宿舍管理中心（后勤楼1楼）',
    phone: '010-12345401',
    materials: ['身份证', '录取通知书/在校证明', '1寸照片2张', '住宿费缴费凭证'],
    steps: [
      { step: 1, title: '查询分配', desc: '在宿舍管理系统查询宿舍分配结果' },
      { step: 2, title: '缴费', desc: '缴纳住宿费并保留凭证' },
      { step: 3, title: '领取钥匙', desc: '到宿舍楼值班室领取宿舍钥匙' },
      { step: 4, title: '检查设施', desc: '入住时检查宿舍设施是否完好' },
      { step: 5, title: '签字确认', desc: '签署入住确认书和设施清单' }
    ],
    content: '## 入住须知\n\n1. 新生入学时由学校统一分配宿舍\n2. 宿舍调整需向学院和宿管中心申请\n3. 严禁私自调换宿舍\n\n## 退宿流程\n\n1. 清理宿舍个人物品\n2. 到宿管中心办理退宿登记\n3. 归还钥匙\n4. 工作人员检查设施完好后签字确认\n5. 办理住宿费结算'
  },
  {
    id: 'guide_finance_001',
    title: '奖学金申请',
    category: 'finance',
    icon: '🏆',
    summary: '国家奖学金、校内奖学金申请流程',
    estimatedTime: '15-30个工作日',
    location: '学生资助管理中心（行政楼3楼）',
    phone: '010-12345005',
    materials: ['奖学金申请表', '成绩单', '获奖证明', '家庭经济情况证明（助学金需）', '个人事迹材料'],
    steps: [
      { step: 1, title: '关注通知', desc: '每学年开学关注奖学金评定通知' },
      { step: 2, title: '准备材料', desc: '按要求准备申请材料' },
      { step: 3, title: '提交申请', desc: '在截止日期前提交至辅导员' },
      { step: 4, title: '班级评议', desc: '班级民主评议推荐' },
      { step: 5, title: '学院评审', desc: '学院评审委员会评审并公示' },
      { step: 6, title: '学校审批', desc: '学校审批并公示最终名单' }
    ],
    content: '## 奖学金类型\n\n| 类型 | 金额 | 条件 |\n|------|------|------|\n| 国家奖学金 | 8000元/年 | 品学兼优 |\n| 国家励志奖学金 | 5000元/年 | 家庭困难且品学兼优 |\n| 一等奖学金 | 3000元/年 | GPA前5% |\n| 二等奖学金 | 2000元/年 | GPA前15% |\n| 三等奖学金 | 1000元/年 | GPA前30% |\n\n## 评定时间\n\n每学年9-10月评定，11月发放'
  },
  {
    id: 'guide_finance_002',
    title: '助学贷款办理',
    category: 'finance',
    icon: '🏦',
    summary: '国家助学贷款申请及办理流程',
    estimatedTime: '20-30个工作日',
    location: '学生资助管理中心（行政楼3楼）',
    phone: '010-12345005',
    materials: ['助学贷款申请表', '身份证及复印件', '家庭经济困难证明', '学生证复印件', '共同借款人身份证'],
    steps: [
      { step: 1, title: '在线注册', desc: '登录国家助学贷款系统注册账号' },
      { step: 2, title: '填写申请', desc: '在线填写贷款申请信息' },
      { step: 3, title: '准备材料', desc: '准备所需纸质材料' },
      { step: 4, title: '学校审核', desc: '资助中心审核申请材料' },
      { step: 5, title: '银行审批', desc: '银行审批并签订合同' },
      { step: 6, title: '贷款发放', desc: '贷款直接划入学校账户抵扣学费' }
    ],
    content: '## 贷款额度\n\n- 本科生：最高12000元/年\n- 研究生：最高16000元/年\n\n## 还款方式\n\n- 在校期间利息由财政补贴\n- 毕业后3年内可只还利息\n- 最长还款期限22年\n\n## 注意事项\n\n1. 诚实申报家庭经济状况\n2. 按时还款，逾期影响个人征信\n3. 可提前还款，无违约金'
  },
  {
    id: 'guide_finance_003',
    title: '学费缴纳与退费',
    category: 'finance',
    icon: '💸',
    summary: '学费缴纳方式及退费流程说明',
    estimatedTime: '1-5个工作日',
    location: '财务处收费科（行政楼1楼）',
    phone: '010-12345006',
    materials: ['校园卡', '银行卡', '退费需提供银行卡复印件'],
    steps: [
      { step: 1, title: '查看应缴金额', desc: '登录教务系统查看本学期应缴费用' },
      { step: 2, title: '选择缴费方式', desc: '线上（微信/银行APP）或线下缴费' },
      { step: 3, title: '完成缴费', desc: '在规定时间内完成缴费' },
      { step: 4, title: '获取凭证', desc: '保存缴费凭证或电子回单' }
    ],
    content: '## 缴费方式\n\n- **线上缴费**：微信校园支付 / 银行APP代扣\n- **线下缴费**：财务处收费窗口\n- **银行汇款**：学校指定账户（需注明学号姓名）\n\n## 退费条件\n\n1. 休学、退学可申请学费退费\n2. 按月计算已使用部分\n3. 退费需学院和财务处审批\n4. 退费至本人银行卡，5-10个工作日到账\n\n## 缓缴申请\n\n家庭经济困难可申请学费缓缴，最迟延期至学期末'
  },
  {
    id: 'guide_career_001',
    title: '就业协议书签订',
    category: 'career',
    icon: '📝',
    summary: '三方协议签订流程及注意事项',
    estimatedTime: '3-7个工作日',
    location: '就业指导中心（大学生活动中心2楼）',
    phone: '010-12345008',
    materials: ['就业协议书', '身份证', '用人单位接收函'],
    steps: [
      { step: 1, title: '领取协议书', desc: '到就业指导中心领取就业协议书' },
      { step: 2, title: '用人单位盖章', desc: '用人单位填写信息并盖章' },
      { step: 3, title: '学院审核', desc: '辅导员审核后学院盖章' },
      { step: 4, title: '学校登记', desc: '交至就业指导中心登记备案' },
      { step: 5, title: '录入系统', desc: '就业信息录入就业管理系统' }
    ],
    content: '## 注意事项\n\n1. 每人仅限领取一份协议书\n2. 协议书遗失需登报声明后补领\n3. 解约需办理解约手续后才能重新领取\n4. 网签与纸质协议具有同等效力\n\n## 违约处理\n\n- 用人单位违约：可申请仲裁\n- 学生违约：需支付违约金（协议约定金额）\n\n## 相关服务\n\n就业指导中心提供：简历指导、模拟面试、法律咨询'
  },
  {
    id: 'guide_career_002',
    title: '创业扶持申请',
    category: 'career',
    icon: '🚀',
    summary: '大学生创业项目扶持与孵化申请',
    estimatedTime: '15-30个工作日',
    location: '创新创业学院（创业大楼3楼）',
    phone: '010-12345009',
    materials: ['创业项目计划书', '团队信息', '营业执照（已注册）', '指导老师推荐信'],
    steps: [
      { step: 1, title: '咨询辅导', desc: '到创新创业学院咨询创业政策和孵化条件' },
      { step: 2, title: '撰写计划书', desc: '准备详细的创业项目计划书' },
      { step: 3, title: '提交申请', desc: '提交入驻孵化基地或申请扶持资金' },
      { step: 4, title: '路演答辩', desc: '参加项目评审路演' },
      { step: 5, title: '签订协议', desc: '评审通过后签订入驻协议' },
      { step: 6, title: '入驻孵化', desc: '获得办公场地、导师指导等资源支持' }
    ],
    content: '## 扶持政策\n\n- **创业孵化基地**：免费办公场地1年\n- **创业启动资金**：最高5万元\n- **创业贷款**：免息贷款最高20万元\n- **导师帮扶**：一对一创业导师指导\n- **税收优惠**：毕业年度内创业减免税费\n\n## 申报时间\n\n每年3月和9月集中评审'
  },
  {
    ...
    category: 'career',
    icon: '📋',
    summary: '实习证明开具及实习学分认定流程',
    estimatedTime: '3-5个工作日',
    location: '各学院教务办公室',
    phone: '010-12345002',
    materials: ['实习协议', '实习鉴定表', '实习日志', '实习报告', '单位盖章证明'],
    steps: [
      { step: 1, title: '实习前备案', desc: '实习前向学院提交实习计划备案' },
      { step: 2, title: '签订协议', desc: '与实习单位签订实习协议' },
      { step: 3, title: '完成实习', desc: '按要求完成实习并填写实习日志' },
      { step: 4, title: '单位鉴定', desc: '实习单位在鉴定表上填写意见并盖章' },
      { step: 5, title: '学分认定', desc: '提交材料至学院进行学分认定' }
    ],
    content: '## 实习要求\n\n- 实习时长不少于8周（专业实习）\n- 需在规定时间内完成实习\n- 自行联系实习单位需提前报备\n\n## 注意事项\n\n1. 实习期间注意安全，购买实习保险\n2. 实习单位须与专业相关\n3. 实习鉴定表需实习单位负责人签字盖章\n4. 未完成实习可能影响毕业'
  },
  {
    ...
    location: '出入境管理处（市公安局出入境大厅）',
    phone: '12367',
    materials: ['身份证原件', '户口本（或户籍证明）', '2寸白底照片', '在校证明', '护照申请表'],
    steps: [
      { step: 1, title: '在线预约', desc: '在出入境管理平台预约办理时间' },
      { step: 2, title: '开具在校证明', desc: '到学校开具在校证明' },
      { step: 3, title: '前往办理', desc: '按时前往出入境大厅办理' },
      { step: 4, title: '现场拍照', desc: '现场拍摄护照照片（也可自带）' },
      { step: 5, title: '缴费', desc: '缴纳护照工本费120元' },
      { step: 6, title: '领取护照', desc: '7-15个工作日后领取或选择快递寄送' }
    ],
    content: '## 办理费用\n\n- 护照工本费：120元/本\n- 加注：20元/项\n\n## 办理时间\n\n- 常规：7-15个工作日\n- 加急：5个工作日（需提供加急事由）\n\n## 在校生特别提醒\n\n1. 部分地区要求学校出具同意出国函\n2. 涉密专业学生需额外审批\n3. 建议提前办理，避免耽误申请截止日期'
  },
  {
    ...
    icon: '🌍',
    summary: '校际交换生项目申请流程',
    estimatedTime: '30-60个工作日',
    location: '国际交流处（国际交流中心2楼）',
    phone: '010-12345010',
    materials: ['交换生申请表', '中英文成绩单', '语言成绩证明', '个人陈述', '推荐信2封', '护照复印件'],
    steps: [
      { step: 1, title: '关注通知', desc: '关注国际交流处发布的交换项目通知' },
      { step: 2, title: '准备材料', desc: '按要求准备申请材料' },
      { step: 3, title: '学院推荐', desc: '获得学院推荐意见' },
      { step: 4, title: '学校选拔', desc: '参加学校组织的面试和选拔' },
      { step: 5, title: '外方录取', desc: '被推荐至合作院校，等待录取通知' },
      { step: 6, title: '办理签证', desc: '收到录取后办理签证手续' }
    ],
    content: '## 申请条件\n\n- GPA不低于3.0（4.0制）\n- 语言成绩达标（托福80+/雅思6.5+，具体看项目要求）\n- 无不及格课程\n- 无违纪记录\n\n## 费用说明\n\n- 交换期间免对方学校学费\n- 住宿费、生活费、往返机票自理\n- 部分项目有奖学金资助\n\n## 学分转换\n\n1. 出国前需制定学习计划\n2. 获得学院课程认定\n3. 回国后提交成绩单进行学分转换'
  },
  {
    id: 'guide_abroad_003',
    title: '留学签证办理',
    category: 'abroad',
    icon: '📋',
    summary: '主要留学国家签证申请流程',
    estimatedTime: '15-45个工作日（因国家而异）',
    location: '各国驻华使领馆签证中心',
    phone: '010-12345010',
    materials: ['护照原件', '录取通知书', '资金证明', '体检证明', '签证申请表', '照片', '学校在读证明'],
    steps: [
      { step: 1, title: '获取录取', desc: '获得海外院校正式录取通知书' },
      { step: 2, title: '在线申请', desc: '在目标国签证申请网站填写信息并预约' },
      { step: 3, title: '准备材料', desc: '按签证要求准备全套材料' },
      { step: 4, title: '体检', desc: '到指定机构进行出国体检' },
      { step: 5, title: '递交材料', desc: '按预约时间到签证中心递交材料和录指纹' },
      { step: 6, title: '等待审批', desc: '等待签证审批结果' }
    ],
    content: '## 各国签证周期\n\n- **美国（F-1）**：面签后3-5个工作日\n- **英国（Tier 4）**：15个工作日\n- **澳大利亚**：2-4周\n- **加拿大**：4-8周\n- **日本**：5-7个工作日\n\n## 资金证明\n\n- 存款金额覆盖1年学费+生活费\n- 存期建议6个月以上\n- 可用父母名下存款（需提供关系证明）\n\n## 国际处可提供\n\n1. 签证指导讲座\n2. 材料审核建议\n3. 在读证明开具'
  },
  {
    ...
    category: 'life',
    icon: '📶',
    summary: '校园WiFi及有线网络开通流程',
    estimatedTime: '即时-1个工作日',
    location: '信息中心（图书馆1楼）',
    phone: '010-12345601',
    materials: ['校园卡', '学号'],
    steps: [
      { step: 1, title: '激活账号', desc: '使用学号在信息中心网站激活网络账号' },
      { step: 2, title: '设置密码', desc: '设置网络登录密码' },
      { step: 3, title: '连接WiFi', desc: '搜索校园WiFi热点并连接' },
      { step: 4, title: '认证登录', desc: '打开浏览器自动跳转认证页面，输入账号密码' },
      { step: 5, title: '开始使用', desc: '认证成功后即可正常上网' }
    ],
    content: '## 网络套餐\n\n- **基础套餐**：免费，20Mbps\n- **标准套餐**：30元/月，50Mbps\n- **高速套餐**：50元/月，100Mbps\n\n## WiFi名称\n\n- `Campus-WiFi`：覆盖教学区\n- `Dorm-WiFi`：覆盖宿舍区\n- `Library-WiFi`：覆盖图书馆\n\n## 常见问题\n\n1. 连接不上：检查账号密码是否正确\n2. 网速慢：切换WiFi频道或升级套餐\n3. 忘记密码：到信息中心重置'
  },
  {
    ...
    category: 'life',
    icon: '🏥',
    summary: '校医院就医及医保报销流程',
    estimatedTime: '即时就医 / 报销15-30个工作日',
    location: '校医院（校园东区）',
    phone: '010-12345701',
    materials: ['校园卡', '身份证', '医保卡', '转诊单（校外就医需）', '发票及费用清单'],
    steps: [
      { step: 1, title: '校医院挂号', desc: '凭校园卡到校医院挂号就诊' },
      { step: 2, title: '医生诊疗', desc: '按号就诊，接受诊疗' },
      { step: 3, title: '缴费取药', desc: '在校医院药房缴费取药（医保直接结算）' },
      { step: 4, title: '校外转诊', desc: '校医院无法处理时开具转诊单' },
      { step: 5, title: '医保报销', desc: '收集材料后到医保办提交报销申请' }
    ],
    content: '## 医保报销比例\n\n- **校医院就诊**：报销80%\n- **转诊校外**：报销60%\n- **急诊校外**：报销50%\n\n## 门诊时间\n\n- 周一至周五：8:00-17:00\n- 周六：8:00-12:00（仅普通门诊）\n- 急诊24小时\n\n## 报销材料\n\n1. 医保报销申请表\n2. 转诊单原件\n3. 医疗费用发票原件\n4. 费用明细清单\n5. 病历复印件'
  },
  {
    ...
    category: 'life',
    icon: '📦',
    summary: '校园快递代收点及寄件方式',
    estimatedTime: '即时',
    location: '菜鸟驿站（学生区商业街）/ 各快递柜',
    phone: '010-12345702',
    materials: ['取件码', '校园卡或身份证'],
    steps: [
      { step: 1, title: '查收取件通知', desc: '收到快递到站短信通知' },
      { step: 2, title: '前往取件', desc: '凭取件码到菜鸟驿站或快递柜取件' },
      { step: 3, title: '身份验证', desc: '出示取件码和校园卡/身份证' },
      { step: 4, title: '确认取走', desc: '核对包裹后取走' }
    ],
    content: '## 代收点分布\n\n| 位置 | 类型 | 营业时间 |\n|------|------|----------|\n| 学生区商业街 | 菜鸟驿站 | 8:00-21:00 |\n| 教学楼A栋 | 快递柜 | 24小时 |\n| 宿舍1-4号楼 | 快递柜 | 24小时 |\n| 宿舍5-8号楼 | 快递柜 | 24小时 |\n\n## 寄件方式\n\n- 菜鸟驿站可寄：顺丰、中通、圆通\n- 大件可预约上门取件\n- 记得填写正确的校内地址和联系方式\n\n## 注意事项\n\n1. 快递保留5天，超时退回\n2. 贵重物品建议当面签收\n3. 取件时检查包裹完好再签收'
  },
  {
    id: 'guide_life_004',
    title: '心理咨询预约',
    category: 'life',
    icon: '💚',
    summary: '心理咨询预约方式及注意事项',
    estimatedTime: '预约后1-3天',
    location: '心理健康教育中心（学生活动中心3楼）',
    phone: '010-12345703',
    materials: ['无需特殊材料', '首次咨询需填写基本信息表'],
    steps: [
      { step: 1, title: '选择预约方式', desc: '线上（公众号预约）或线下（到中心预约）' },
      { step: 2, title: '选择时间', desc: '选择合适的咨询时段' },
      { step: 3, title: '填写信息', desc: '填写基本个人信息和咨询需求' },
      { step: 4, title: '按时到访', desc: '按预约时间到心理咨询室' },
      { step: 5, title: '接受咨询', desc: '与咨询师进行一对一交流' }
    ],
    content: '## 咨询类型\n\n- **个体咨询**：一对一心理咨询\n- **团体辅导**：主题团体心理辅导\n- **危机干预**：紧急心理危机援助\n\n## 服务时间\n\n- 周一至周五：8:30-11:30，14:00-17:00\n- 24小时心理热线：010-12345703\n\n## 保密原则\n\n1. 咨询内容严格保密\n2. 未经本人同意不向第三方透露\n3. 例外情况：危及自身或他人安全时\n\n> 主动寻求帮助是勇敢的表现 💪'
  }
];
...
const MOCK_TUTOR_LIST = [
  {
    id: 'tutor_001',
    tutorName: '张学长',
    tutorAvatar: 'https://picsum.photos/seed/tutor1/200/200',
    tutorId: '20230001',
    college: '计算机学院',
    grade: '2022级',
    major: '软件工程',
    subjects: ['math', 'programming', 'physics'],
    grades: ['junior', 'senior', 'college'],
    hourlyRate: 120,
    teachingMethod: 'both',
    availableDays: ['1', '2', '3', '4', '5', '6', '7'],
    availableTimeSlots: ['evening', 'weekend'],
    intro: '高考数学145分，物理满分。擅长高中数理化以及C++、Python编程辅导。有两年家教经验，辅导过10+学生，平均提分20分以上。',
    gradeProofImages: [
      'https://picsum.photos/seed/tutor1_proof1/800/600',
      'https://picsum.photos/seed/tutor1_proof2/800/600'
    ],
    tags: ['专业度高', '耐心细致'],
    status: 'active',
    rating: 4.9,
  ...
  },
  {
    id: 'tutor_002',
    tutorName: '李学姐',
    tutorAvatar: 'https://picsum.photos/seed/tutor2/200/200',
    tutorId: '20220056',
    college: '外国语学院',
    grade: '2021级',
    major: '英语专业',
    ...
    availableDays: ['6', '7'],
    availableTimeSlots: ['morning', 'afternoon', 'weekend'],
    intro: '英语专业八级，雅思8分。擅长英语语法、写作和口语教学。教学风格活泼有趣，注重培养学生的学习兴趣。',
    gradeProofImages: [
      'https://picsum.photos/seed/tutor2_proof1/800/600'
    ],
    tags: ['亲切友善', '耐心细致'],
    status: 'active',
    rating: 4.8,
    ...
    sessionCount: 208,
    creditScore: 92,
    createTime: now - 45 * 86400000
  },
  {
    id: 'tutor_003',
    tutorName: '王学长',
    tutorAvatar: 'https://picsum.photos/seed/tutor3/200/200',
    tutorId: '20210123',
    college: '经济管理学院',
    grade: '2020级',
    major: '金融学',
    subjects: ['math', 'politics', 'history'],
    grades: ['senior', 'college'],
    hourlyRate: 150,
    teachingMethod: 'offline',
    availableDays: ['5', '6', '7'],
    availableTimeSlots: ['afternoon', 'evening', 'weekend'],
    intro: '考研数学140分，文综成绩优异。熟悉高考文科复习方法，擅长数学基础巩固和拔高训练。',
    gradeProofImages: [
      'https://picsum.photos/seed/tutor3_proof1/800/600',
      'https://picsum.photos/seed/tutor3_proof2/800/600',
      'https://picsum.photos/seed/tutor3_proof3/800/600'
    ],
    tags: ['备课充分', '效果显著'],
    status: 'busy',
    rating: 5.0,
    ...
    sessionCount: 286,
    creditScore: 95,
    createTime: now - 60 * 86400000
  },
  {
    id: 'tutor_004',
    tutorName: '陈学姐',
    tutorAvatar: 'https://picsum.photos/seed/tutor4/200/200',
    tutorId: '20230089',
    college: '化学化工学院',
    grade: '2022级',
    major: '应用化学',
    ...
    intro: '高中化学竞赛省一等奖，理综280分。擅长化学生物知识点归纳总结，帮助学生建立完整知识体系。',
    gradeProofImages: [
      'https://picsum.photos/seed/tutor4_proof1/800/600'
    ],
    tags: ['专业度高', '效果显著'],
    status: 'active',
    rating: 4.7,
  ...
  },
  {
    id: 'tutor_005',
    tutorName: '刘学长',
    tutorAvatar: 'https://picsum.photos/seed/tutor5/200/200',
    tutorId: '20220456',
    college: '机械工程学院',
    grade: '2021级',
    major: '机械工程',
    ...
    intro: '数学物理竞赛双料省二，擅长逻辑思维训练。讲解深入浅出，善于把复杂问题简单化。',
    gradeProofImages: [
      'https://picsum.photos/seed/tutor5_proof1/800/600',
      'https://picsum.photos/seed/tutor5_proof2/800/600'
    ],
    tags: ['专业度高', '准时守信'],
    status: 'active',
    rating: 4.9,
    ...
    sessionCount: 142,
    creditScore: 88,
    createTime: now - 40 * 86400000
  },
  {
    id: 'tutor_006',
    tutorName: '赵学姐',
    tutorAvatar: 'https://picsum.photos/seed/tutor6/200/200',
    tutorId: '20240034',
    college: '艺术设计学院',
    grade: '2023级',
    major: '视觉传达',
    ...
    intro: '从小学习绘画和钢琴，美术十级钢琴十级。热爱艺术教育，善于激发孩子的艺术天赋。',
    gradeProofImages: [
      'https://picsum.photos/seed/tutor6_proof1/800/600'
    ],
    tags: ['亲切友善', '耐心细致'],
    status: 'active',
    rating: 4.6,
...
const MOCK_TUTOR_DEMAND_LIST = [
  {
    id: 'demand_001',
    studentName: '小林同学',
    studentAvatar: 'https://picsum.photos/seed/student1/200/200',
    ...
    duration: 2,
    description: '高三学生，数学目前100分左右，想冲刺130+。重点复习函数、解析几何、导数。希望有经验的老师辅导，最好带过高三学生。',
    location: '学校附近',
    urgent: true,
  ...
  },
  {
    id: 'demand_002',
    studentName: '小周妈妈',
    studentAvatar: 'https://picsum.photos/seed/student2/200/200',
    ...
    duration: 1.5,
    description: '初二学生，英语成绩中等，主要是阅读理解和写作丢分多。想找英语专业的大学生辅导，提升阅读技巧和写作能力。',
    location: '线上辅导',
    urgent: false,
    startDate: now + 5 * 86400000,
    status: 'open',
    views: 28,
    createTime: now - 1 * 86400000
  },
  {
    id: 'demand_003',
    studentName: '小陈爸爸',
    studentAvatar: 'https://picsum.photos/seed/student3/200/200',
    ...
    preferredTimeSlots: ['evening'],
    duration: 2,
    description: '高二学生，物理电磁学部分学不懂，考试经常不及格。需要有耐心的老师，从基础开始讲起。',
    location: '学校东门',
    urgent: false,
    startDate: now + 7 * 86400000,
    status: 'matched',
    views: 36,
    matchedTutorId: 'tutor_005',
    createTime: now - 5 * 86400000
  },
  {
    id: 'demand_004',
    studentName: '小吴同学',
    studentAvatar: 'https://picsum.photos/seed/student4/200/200',
    ...
    duration: 1.5,
    description: '计算机专业大一学生，C++课程学起来很吃力，指针和面向对象部分不理解。需要有耐心的学长学姐辅导作业和知识点。',
    location: '线上辅导',
    urgent: true,
    startDate: now + 1 * 86400000,
    status: 'open',
    views: 52,
    createTime: now - 1 * 86400000 / 2
  },
  {
    id: 'demand_005',
    studentName: '小王妈妈',
    studentAvatar: 'https://picsum.photos/seed/student5/200/200',
    ...
    preferredTimeSlots: ['morning', 'afternoon'],
    duration: 1.5,
    description: '高一新生，化学入门困难，化学方程式总是记不住，实验题不会做。希望能找化学院的学生辅导，培养化学学习兴趣。',
    location: '学校南门附近',
    urgent: false,
    startDate: now + 10 * 86400000,
    status: 'open',
    views: 23,
...
const MOCK_TUTOR_APPOINTMENT_LIST = [
  {
    id: 'appt_001',
    tutorId: 'tutor_001',
    tutorName: '张学长',
    ...
    subject: 'physics',
    grade: 'senior',
    appointmentDate: now + 3 * 86400000,
    timeSlot: 'evening',
    startTime: '19:00',
    endTime: '21:00',
    duration: 2,
  ...
  },
  {
    ...
    subject: 'english',
    grade: 'junior',
    appointmentDate: now + 1 * 86400000,
    timeSlot: 'evening',
    startTime: '19:30',
    endTime: '21:00',
    duration: 1.5,
    ...
    totalAmount: 150,
    status: 'pending',
    notes: '线上辅导，请提前下载腾讯会议',
    tutorReviewed: false,
    studentReviewed: false,
    createTime: now - 12 * 3600000
  },
  {
    id: 'appt_003',
    tutorId: 'tutor_003',
    ...
    demandId: null,
    studentName: '小明同学',
    studentAvatar: 'https://picsum.photos/seed/student_old1/200/200',
    subject: 'math',
    grade: 'senior',
    appointmentDate: now - 5 * 86400000,
    timeSlot: 'afternoon',
    startTime: '14:00',
    endTime: '16:00',
    duration: 2,
  ...
  },
  {
    ...
    demandId: null,
    studentName: '小李同学',
    studentAvatar: 'https://picsum.photos/seed/student_old2/200/200',
    subject: 'chemistry',
    grade: 'senior',
    appointmentDate: now - 2 * 86400000,
    timeSlot: 'evening',
    startTime: '19:00',
    endTime: '20:30',
    duration: 1.5,
...
const MOCK_TUTOR_REVIEW_LIST = [
  {
    id: 'review_001',
    appointmentId: 'appt_003',
    tutorId: 'tutor_003',
    reviewerId: 'student_old1',
    reviewerName: '小明同学',
    reviewerAvatar: 'https://picsum.photos/seed/student_old1/200/200',
    reviewerRole: 'student',
    targetRole: 'tutor',
    rating: 5,
    tags: ['professional', 'patient', 'effective', 'prepared'],
    content: '王学长讲得非常好，函数部分之前一直是我的弱项，这次两小时的辅导把很多以前没搞懂的知识点都讲透了。特别是换元法和分类讨论的思路，让我豁然开朗。下次还要继续约！',
    createTime: now - 4 * 86400000
  },
  {
    id: 'review_002',
    appointmentId: 'appt_003',
    studentName: '小明同学',
    studentId: 'student_old1',
    reviewerId: 'tutor_003',
    reviewerName: '王学长',
    reviewerAvatar: 'https://picsum.photos/seed/tutor3/200/200',
    reviewerRole: 'tutor',
    targetRole: 'student',
    rating: 5,
    tags: ['punctual', 'friendly', 'prepared'],
    content: '小明同学学习态度非常认真，提前做好了预习，课上也积极提问。数学基础不错，只要继续保持这个学习劲头，成绩一定能有很大提升！',
    createTime: now - 4 * 86400000 + 3600000
  },
  {
    id: 'review_003',
    appointmentId: 'appt_004',
    tutorId: 'tutor_004',
    reviewerId: 'student_old2',
    reviewerName: '小李同学',
    reviewerAvatar: 'https://picsum.photos/seed/student_old2/200/200',
    reviewerRole: 'student',
    targetRole: 'tutor',
    rating: 4,
    tags: ['professional', 'prepared'],
    content: '陈学姐的化学辅导很专业，知识点讲得很系统。但希望下次可以多讲一些例题，多一些互动练习。',
    createTime: now - 1 * 86400000
  }
];

const MOCK_TUTOR_CREDIT_BIND_LIST = [
  {
    id: 'credit_001',
    userId: 'tutor_001',
    type: 'student_id',
    imageUrl: 'https://picsum.photos/seed/credit1/800/600',
    verifyInfo: '计算机学院 2022级 软件工程',
    status: 'approved',
    submitTime: now - 35 * 86400000,
    reviewTime: now - 34 * 86400000
  },
  {
    id: 'credit_002',
    userId: 'tutor_001',
    type: 'transcript',
    imageUrl: 'https://picsum.photos/seed/credit2/800/600',
    verifyInfo: '上学期GPA: 3.85/4.0',
    status: 'approved',
    submitTime: now - 35 * 86400000,
    reviewTime: now - 34 * 86400000
  },
  {
    ...
    userId: 'tutor_001',
    type: 'campus_card',
    imageUrl: 'https://picsum.photos/seed/credit3/800/600',
    verifyInfo: '校园卡已绑定',
    status: 'approved',
    submitTime: now - 35 * 86400000,
    reviewTime: now - 34 * 86400000
  },
  {
    ...
    userId: 'tutor_002',
    type: 'student_id',
    imageUrl: 'https://picsum.photos/seed/credit4/800/600',
    verifyInfo: '外国语学院 2021级 英语专业',
    status: 'approved',
    submitTime: now - 50 * 86400000,
    reviewTime: now - 49 * 86400000
  },
  {
    id: 'credit_005',
    userId: 'tutor_002',
    type: 'certificate',
    imageUrl: 'https://picsum.photos/seed/credit5/800/600',
    verifyInfo: '英语专业八级证书',
    status: 'approved',
    submitTime: now - 50 * 86400000,
    reviewTime: now - 49 * 86400000
  },
  {
    ...
    userId: 'tutor_003',
    type: 'student_id',
    imageUrl: 'https://picsum.photos/seed/credit6/800/600',
    verifyInfo: '经济管理学院 2020级 金融学',
    status: 'approved',
    submitTime: now - 65 * 86400000,
    reviewTime: now - 64 * 86400000
  },
  {
    id: 'credit_007',
    userId: 'tutor_003',
    type: 'identity',
    imageUrl: 'https://picsum.photos/seed/credit7/800/600',
    verifyInfo: '实名认证通过',
    status: 'approved',
    submitTime: now - 65 * 86400000,
    reviewTime: now - 64 * 86400000
  },
  {
    ...
    userId: 'tutor_003',
    type: 'certificate',
    imageUrl: 'https://picsum.photos/seed/credit8/800/600',
    verifyInfo: '考研数学140分证明',
    status: 'approved',
    submitTime: now - 65 * 86400000,
    reviewTime: now - 64 * 86400000
  }
...
const _tutorExports = {
  MOCK_TUTOR_LIST,
  MOCK_TUTOR_DEMAND_LIST,
  MOCK_TUTOR_APPOINTMENT_LIST,
  MOCK_TUTOR_REVIEW_LIST,
