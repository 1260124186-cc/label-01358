...
const STORAGE_KEYS = {
  ...
  POINT_COMPLETED_TASKS: 'pointCompletedTasks',
  POINT_MALL_PRODUCTS: 'pointMallProducts',
  POINT_MALL_ORDERS: 'pointMallOrders',
  ...
  ERRAND_DISPUTE_LIST: 'errandDisputeList',
  ERRAND_ARBITRATION_LOG: 'errandArbitrationLog',
  ERRAND_ESCROW_LOG: 'errandEscrowLog',
  RENTAL_LIST: 'rentalList',
  RENTAL_COMPARE_LIST: 'rentalCompareList',
  RENTAL_AGENT_REPORTS: 'rentalAgentReports',
  RENTAL_VIEWING_APPOINTMENTS: 'rentalViewingAppointments',
  RENTAL_VIEWING_CHECKINS: 'rentalViewingCheckins',
  RENTAL_CONTRACT_CHECKLIST: 'rentalContractChecklist',
  ...
  LOST_FOUND_CLAIM_APPLICATIONS: 'lostFoundClaimApplications',
  LOST_FOUND_VERIFY_CODES: 'lostFoundVerifyCodes',
  LOST_FOUND_CLAIM_REVIEWS: 'lostFoundClaimReviews',
